# **ADK - 이탈 없이 기존 콘텐츠에 녹아드는, 끊김없는 유저 경험을 위한 AI**
...
---
 <code style="color : aquamarine">ADK는 이런 기업/단체를 위해설계되었습니다.</code>
...
**<code style="color : green">인터랙션</code> - 유저의 탐색의지를 자극하며, 능동적인 상호작용으로 이어지도록 설계된 인터랙션 경험**
