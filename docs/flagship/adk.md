# **ADK - 별도 이탈 없이 기존 콘텐츠에 녹아드는,끊김없는 유저 경험을 위한 AI**
...
### **<code style="color : green">확장 - 기존 콘텐츠 환경은 유지하면서, 별도의 플랫폼 이동 없이 AI로만 확장하는 서비스** ###
...
### **<code style="color : green">인터랙션 - 유저의 탐색의지를 자극해, 능동적인 상호작용으로 이어지도록 설계된 인터랙션 경험** ###
