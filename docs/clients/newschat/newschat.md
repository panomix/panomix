# **뉴스챗 - 국내 언론사 최초의 대화형 생성형 AI**

뉴스챗은 뉴스 독자의 궁금증을 실시간으로 해소하며,
...
파노믹스는 클라이언트 인터뷰와 리서치를 통해, 기존 뉴스 플랫폼의 한계를 다음과 같이 인식하고 있었습니다:
...
클라이언트는 단순히 기사를 읽는 데서 그치지 않고, 유저가 뉴스를 중심으로 질문하고 답변을 주고받는 상호작용형 뉴스 소비 경험을 만들고자 했습니다.
...
단순히 생성형 AI 기술을 도입하는 데 그치지 않고, 실제 클라이언트의 유저 그룹과 유저 여정, 행동 데이터까지 면밀히 분석한 후, 이를 기반으로 지속 가능한 수익 구조와 트래픽 선순환 구조를 성공적으로 구축했습니다. 

---

### <code style="color : orangered">성과 Performance</code> 
- MAU 100만 명 돌파 (5개월)
- 세션당 기사 조회 수 & 광고 수익 증가 (CTR 10%)
- 뉴스챗 유저 한정 체류시간 250% 증가
...
### 파노믹스와의 협업을 원하신다면, 간단한 정보를 남겨주세요. ###
  ...
  👉 <a href="https://https://forms.gle/Jpzzf9gE25yAwJBWA" target="_blank">구글폼 작성하기</a> 또는 
