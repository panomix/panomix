...
파노믹스는 자체 개발 플래그십 프로덕트도 운영 중인 동시에, 클라이언트 맞춤형 프로젝트도 운영 중입니다. 빠른 실행력과 유연한 개선 사이클을 통해, 고객이 짧은 시간 안에 실질적인 가치를 체감할 수 있도록 지원합니다. 
파노믹스의 클라이언트 맞춤형 솔루션은 2가지 단계로 나뉩니다. 

![Product Image](images/discover.png)
